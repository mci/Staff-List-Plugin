...
class Simple_Staff_List_Activator {
	...
	public static function activate( $is_forced = false ) {
		$default_template = '
		[staff_loop]
		    <li class="staff-bio person">
		        <div class="image-wrapper" style="background-image: url([staff-photo-url])" title="[staff-name]">
		            <i></i>
		        </div>
		        <div class="staff-name-title">
		            <h4>[staff-name]</h4>
		            <p class="job-title">[staff-position]</p>
		        </div>
		        <div class="staff-info modal modal-valign fade in" style="display:none;" tabindex="-1" role="dialog" aria-labelledby="staffPopupLabel" aria-hidden="false">
		            <div class="modal-dialog">
		                <div class="modal-content">
		                    <div class="modal-header">
		                        <button type="button" class="btn-md close modal-close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
		                        <div class="modal-image-wrapper" style="background-image: url([staff-photo-url])"></div>
		                    ...
		                    <div class="modal-body">
		                        <div class="modal-blurb bio-blurb">
		                            [staff-bio]
		                        </div>
		                    </div>
		                </div>
